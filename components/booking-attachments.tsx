...
export function BookingAttachments({ booking, onSave, onBack }: { booking: Booking; onSave: (booking: Booking) => Promise<void>; onBack: () => void }) {
  ...
  return <section className="booking-workspace booking-attachments-page" aria-label="Booking attachments">
    <div className="booking-attachments-top"><button className="booking-back-button" onClick={onBack} aria-label="Back"><span>‹</span></button><div><small>HMS</small><strong>HOTEL PARADISE</strong></div></div>
    <div className="booking-attachments-breadcrumb">… / … / Attachments</div>
