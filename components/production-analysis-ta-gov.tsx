...
function sourceOf(booking: Booking) {
  return booking.segment || booking.salesChannel || booking.source || 'Walk In';
}
...
export function ProductionAnalysisTAGov({ bookings, hotelMasters, date, onDate, onBack }: {
  bookings: Booking[];
