...
function displayDate(value: string) { const [year, month, day] = value.split('-'); return year && month && day ? `${day}/${month}/${year}` : value; }`nfunction ValidityRow({ row, onEdit }: { row: RateValidityItem; onEdit: () => void }) {
