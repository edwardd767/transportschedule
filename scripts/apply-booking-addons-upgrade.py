...
addon_block = """            {applicableAddOns.length > 0 && <div style={{ gridColumn: '1 / -1', borderTop: '1px solid #e5e5e5', paddingTop: 10, marginTop: 2 }}>
...
"""
child_field = '            <label className="booking-line-field"><span>Child (MYR)</span><input value={money.format(extraChildRate)} readOnly disabled={!childRatesApplied} /></label>\n'
...
replace_once(path, child_field, child_field + addon_block)
