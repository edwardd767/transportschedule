...
for(const value of ['Corp/TA','A/C/I','5/2/0','Nationality','Segment','Company','Malaysian','SPK','DLQ','Total Adult: 5','Total Child: 2','Total Room: 3']) assert.ok(html.includes(value),value);
...
console.log('Report: 25 columns, combined A/C/I, linked profiles, adult/child totals, multi-room counts and date filtering pass.');
