...
var initialRateElementIds = [
  "fab777fa-7181-4b7c-9829-ed115152a0e1",
  "8f9358c9-58dc-4fba-be17-81c8c960bec4",
  "2927a65d-9737-47d4-a2d4-8f39dd33a232",
  "0756f229-3f94-4f6e-bc98-d1615e10038a",
  "c8eeabfd-de23-4dee-ba34-65f4a2238e28",
  "edb73a4c-cd96-4e7b-8f50-a375be52e806",
  "515a379b-24dc-4732-bb4a-4c5a677bbcf4",
  "52011b11-db65-4b78-a83b-8517a7397932",
  "b14d8974-f269-40dd-8a20-274dc9652898",
  "032d4a59-84e7-4777-bbcb-d656dba7ebba",
  "d3c5e31d-8eab-44c2-a677-3c6e2ddb115e",
  "a0fbfbb2-c66c-4bd9-88b1-23d569f32341",
  "fd6fa3f5-9490-42a0-81fc-28884ccc182b",
  "f03b8f65-219b-4983-95f3-6f9afdd375e1",
  "3be482fd-481d-48db-8f96-a41c90887cda",
  "906d01cc-04cd-47e2-b16c-be98fde9044d",
  "9db17fc3-d9c0-4625-b289-de9940ff57a1",
  "d0fb958d-de84-42e4-9f38-0b7495471589",
  "bf42a61e-6b69-4045-b6bb-30d093bd7f52",
  "1bdc30dc-c1fb-4733-bb11-92c58a5891ee",
  "3a54db56-ae07-462c-84b5-31137683681b",
  "bd7d02d2-8c89-4523-a64f-beae3d0f4d6a",
  "e35707c6-1666-4d8a-840e-a937561f7bc4",
  "3edbbadb-1251-4d84-bded-e16460abd4bc",
  "e699c744-5c6c-4b4f-a761-364f0161bb36"
];
...
function rateSetup(value) {
  ...
  const validity = list(v.validity, 4e3).map((entry) => {
    ...
    const addOnElements = list(row.addOnElements).map((value2) => text(value2, "add-on element ID", true, 100));
...
function applyTransportAction(state, input) {
  ...
  switch (action.type) {
    ...
    case "roomingEnsure": {
      ...
      const profile = { id: crypto.randomUUID(), name: booking.guest, mobile: booking.phone || "", email: booking.email || "", nationality: "Malaysian", identityNo: "", address: "", country: "Malaysia", state: "", city: "", postcode: "", birthDate: "", occupation: "", accountName: "", guestType: "Normal", adultChild: "Adult", remark: "", newsletter: false, tourismTax: false, visits: 0, updated: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) };
    ...
    case "bookingCreate": {
      ...
      const profile = { id: crypto.randomUUID(), name: value.guest, mobile: value.phone || "", email: value.email || "", nationality: "Malaysian", identityNo: "", address: "", country: "Malaysia", state: "", city: "", postcode: "", birthDate: "", occupation: "", accountName: value.accountName || "", guestType: "Normal", adultChild: "Adult", remark: "", newsletter: false, tourismTax: false, visits: 0, updated: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) };
...
var schemaStatements = [
  ...
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS company_reg_no text NOT NULL DEFAULT ''`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS sst_reg_no text NOT NULL DEFAULT ''`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS ttx_reg_no text NOT NULL DEFAULT ''`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS online_booking_url text NOT NULL DEFAULT ''`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS live_run_date text NOT NULL DEFAULT ''`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS contact_person text NOT NULL DEFAULT ''`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS phone_no text NOT NULL DEFAULT ''`,
  ...
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS booking_cancellation_days integer NOT NULL DEFAULT 3`,
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS currency_code text NOT NULL DEFAULT 'MYR'`,
  ...
  BEGIN
    ...
    INSERT INTO public.hotelx_rate_setup (property_id, id, sort_order, code, description, rate_type_id, rate_frequency, active, web, last_updated_on)
    ...
    INSERT INTO public.hotelx_rate_setup_validity (property_id, rate_setup_id, id, sort_order, valid_from, valid_to, active, seasonal_rates, inclusive_elements, add_on_elements)
  ...
  SELECT
    ...
    jsonb_build_object(
      ...
      'paymentTypes', COALESCE((SELECT jsonb_agg(jsonb_build_object('id', p.payment_type_id, 'sortOrder', p.sort_order, 'description', p.description, 'active', p.active, 'auditDate', to_char(p.audit_date, 'YYYY-MM-DD')) ORDER BY p.sort_order) FROM public.hotelx_payment_type p WHERE p.property_id = meta.property_id), '[]'::jsonb),
      'bookings', COALESCE((
        SELECT jsonb_agg(jsonb_build_object(
