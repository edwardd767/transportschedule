...
var schemaStatements = [
  ...
  `ALTER TABLE public.hotelx_hotel_setup ADD COLUMN IF NOT EXISTS pax_count text NOT NULL DEFAULT 'No. of Guest Profile Created'`,
